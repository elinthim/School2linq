...
namespace School2linq.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(SchooltwolinqDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teachers != null ? 
                          ...
                          Problem("Entity set 'SchooltwolinqDBContext.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchooltwolinqDBContext.Teachers'  is null.");
            }
            var teacher = await _context.Teachers.FindAsync(id);
            if (teacher != null)
            {
